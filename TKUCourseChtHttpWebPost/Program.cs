...
namespace TKUCourseChtHttpWebPost
{
    class Program
    {
    ...
    public class TKUCourse
    {
        ...
        public bool get_login_key()
        {
            ...
            try
            {
                webRequest = (HttpWebRequest)WebRequest.Create("http://www.ais.tku.edu.tw/elecos/");
        ...
        public bool login(string stu_id, string stu_pwd)
        {
            ...
            try
            {
                webReq = (HttpWebRequest)HttpWebRequest.Create("http://www.ais.tku.edu.tw/elecos/");
                webReq.Method = "POST";
        ...
        public bool add_course(string course_id)
        {
            ...
            try
            {
                webReq = (HttpWebRequest)HttpWebRequest.Create("http://www.ais.tku.edu.tw/elecos/action.aspx");
                webReq.Method = "POST";
                webReq.ContentType = "application/x-www-form-urlencoded";
                ...
                content = sr.ReadToEnd();
                if (content.IndexOf("I000") != -1) return true;
                else return false;
            }
            catch (Exception ee) { return false; }
        }
